...
class RVadapter(val activity: Activity):RecyclerView.Adapter<RVadapter.ViewHolder>() {
...
//        if(service.isWanted){
//            binding.imageViewIcon.foreground = ResourcesCompat.getDrawable(activity.resources,R.drawable.image_overlay,null)
//        }else{
